# SkipCord-3: Omegle Streaming Bot for Discord (v7)
...
This version (v7) introduces a granular, decorator-based permission system, powerful new moderation tools, and significant stability and UI improvements.
