...
- **Help Menu**:  
  ...
  ![12](https://github.com/user-attachments/assets/015b7d55-8cf9-4d03-8a2b-bb86b3f47aa1)
...
- **Button Cooldowns**:  
  ...
  *(See the `HelpView` and `HelpButton` classes.)*
  ...
  ![44](https://github.com/user-attachments/assets/761778e2-6859-4318-9117-3d8e418705ef)
